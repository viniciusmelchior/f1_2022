                ...
                @foreach ($temporadas as $key => $temporada)
                    <tr>
                        ...
                        <td style="text-center">
                            <a data-toggle="tooltip" data-placement="top" title="Editar Relação de Forças" href="{{route('equipes.relacaoForcas.listagemEquipes', [$temporada->id])}}"><i class="bi bi-pencil-fill"></i></a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
